...
htmlhelp_basename = 'Experimentordoc'
...
latex_documents = [
    (master_doc, 'Experimentor.tex', 'Experimentor Documentation',
...
man_pages = [
    (master_doc, 'Experimentor', 'Experimentor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Experimentor', 'Experimentor Documentation',
     author, 'Experimentor', 'One line description of project.',
     'Miscellaneous'),
]
